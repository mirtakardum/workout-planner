...
function WorkoutTable(){
    return(
        ...
        <div className="rounded-lg overflow-x-auto">
            <table className="rounded-lg py-4 shadow-neumorphicPressed border-separate table-fixed text-sm text-left rtl:text-right text-gray-500">
                <thead className="text-xs text-slate-200 uppercase">
                    <tr>
                        <th scope="col" className="px-6 py-2 font-poppins">
                            Exercise
                        </th>
                        <th scope="col" className="px-6 py-2 font-poppins">
                            Weight
